...
object Creatures {
    val mockCreaturesLocal = listOf(
        CreatureDtoX(
            ...
            type = CreatureSubCategory.BOSS.name, // BOSS creature
            name = "Dragon",
        ...
        CreatureDtoX(
            ...
            type = CreatureSubCategory.MINI_BOSS.name, // MINI_BOSS creature
            name = "Goblin King",
            primarySpawn = "Cave",
        ...
        CreatureDtoX(
            ...
            biomeId = "biome-3",
            typeName = "Wild Boar",
            type = CreatureSubCategory.AGGRESSIVE_CREATURE.name, // An aggressive creature
            name = "Wild Boar",
            primarySpawn = "Forest",
            summoningItems = null,
            baseHP = 500,
        ...
        CreatureDtoX(
            ...
            type = CreatureSubCategory.NPC.name, // An NPC creature
            name = "Forest Sprite",
    ...
    val mockCreaturesApi = listOf(
        ...
        CreatureDtoX(
            ...
            type = CreatureSubCategory.AGGRESSIVE_CREATURE.name, // Aggressive creature
            name = "Raging Wolf",
        ...
        CreatureDtoX(
            ...
            type = CreatureSubCategory.PASSIVE_CREATURE.name, // Passive creature
            name = "Gentle Deer",
