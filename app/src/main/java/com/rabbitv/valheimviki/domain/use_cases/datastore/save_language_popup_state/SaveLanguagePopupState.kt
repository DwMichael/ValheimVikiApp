...
class SaveLanguagePopupState @Inject constructor(private val dataStoreRepository: DataStoreRepository) {
	suspend operator fun invoke(shown: Boolean) {
		return dataStoreRepository.saveLanguagePopupState(shown)
	}
}
