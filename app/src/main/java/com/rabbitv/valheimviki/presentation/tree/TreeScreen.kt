...
import com.rabbitv.valheimviki.presentation.tree.viewmodel.TreeUIState
...
fun TreeScreen(
    ...
    val treeUIState: TreeUIState by viewModel.treeUIState.collectAsStateWithLifecycle()
    ...
    Box(
        ...
        Surface(
            ...
            when {
                treeUIState.isLoading || (treeUIState.trees.isEmpty() && isConnection) -> {
                    ShimmerGridEffect()
                }

                (treeUIState.error != null || !isConnection) && treeUIState.trees.isEmpty() -> {
                    Box(
